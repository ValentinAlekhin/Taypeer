...
/// Window header projecting database commands and current navigation.
pub struct Header {
    store: Entity<WorkspaceStore>,
    _subscription: Subscription,
}
impl Header {
    /// Observe the workflow for the lifetime of the header entity.
...
impl Render for Header {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        TitleBar::new()
            // Native titlebar and traffic-light exclusion remain physical platform geometry.
            .h(px(34.))
            .pl_0()
            .border_b_1()
            ...
            .child(
                h_flex()
                    ...
                    .child(div().absolute().right(rems(0.5)).top(rems(0.0625)).child(
