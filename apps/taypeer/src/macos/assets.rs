...
fn ui_icon(name: &str) -> gpui_kit::Result<Option<std::borrow::Cow<'static, [u8]>>> {
    ...
    let bundled: Option<&'static [u8]> = match name {
        "trash-2" => Some(include_bytes!("../../../../resources/lucide/trash-2.svg")),
        "download" => Some(include_bytes!("../../../../resources/lucide/download.svg")),
        "refresh-cw" => Some(include_bytes!(
            "../../../../resources/lucide/refresh-cw.svg"
        )),
        "bookmark" => Some(include_bytes!("../../../../resources/lucide/bookmark.svg")),
        "credit-card" => Some(include_bytes!(
            "../../../../resources/lucide/credit-card.svg"
        )),
        "database" => Some(include_bytes!("../../../../resources/lucide/database.svg")),
        ...
        "key-round" => Some(include_bytes!("../../../../resources/lucide/key-round.svg")),
        ...
        "terminal" => Some(include_bytes!("../../../../resources/lucide/terminal.svg")),
